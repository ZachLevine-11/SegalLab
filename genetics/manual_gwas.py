...
def manual_assoc_test(boxplot, SNPdf, pheno):
    covars = pd.read_csv("/net/mraid08/export/jasmine/zach/height_gwas/covariates_with_age_gender.txt", sep="\t").drop(
        "FID", axis=1)
...
def manual_associate_top_k_hits_compare(boxplot=True, var='pregnancy_end_reason_[JA62]', loader=ChildrenLoader,
                                        plink_data=None,
                                        gwas_results_renamed_dir="/net/mraid08/export/jasmine/zach/height_gwas/all_gwas/gwas_results_renamed/"):
    manual_res = {}
    plink_res = {}
